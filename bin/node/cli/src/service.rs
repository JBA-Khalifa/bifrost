...
type FullClient = sc_service::TFullClient<Block, RuntimeApi, crate::executor::Executor>;
type FullBackend = sc_service::TFullBackend<Block>;
type FullSelectChain = sc_consensus::LongestChain<FullBackend, Block>;
type FullGrandpaBlockImport =
	grandpa::GrandpaBlockImport<FullBackend, Block, FullClient, FullSelectChain>;
type LightClient = sc_service::TLightClient<Block, RuntimeApi, crate::executor::Executor>;
...
>, ServiceError> {
	let (client, backend, keystore, task_manager) =
		sc_service::new_full_parts::<Block, RuntimeApi, crate::executor::Executor>(&config)?;
...
pub fn new_light_base(config: Configuration) -> Result<(
	...
	let (client, backend, keystore, mut task_manager, on_demand) =
		sc_service::new_light_parts::<Block, RuntimeApi, crate::executor::Executor>(&config)?;
